...
for trial_idx in range(n_trials):
  ...
  dim_size = len(U_idx)
  # obj = create_objective(name, cl_algo, dim_size, attack_balance, attack_entropy, attack_min_cluster_ratio)  
  # budget = calculate_budget(name, cl_algo)
  dim = Dimension(dim_size, [[0, 1]]*dim_size, [False]*dim_size)
  obj = Objective(combined_attack, dim) # Trying out new attack
  budget = 20
  solution = Opt.min(obj, Parameter(budget=budget)) 
